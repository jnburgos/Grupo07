...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { length: @chapter.length, season: @chapter.season } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { length: @chapter.length, season: @chapter.season } }
